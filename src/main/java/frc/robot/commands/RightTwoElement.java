...
public class RightTwoElement extends SequentialCommandGroup {
  public RightTwoElement(
      ...
      EndAffectorSubsystem endAffector) {
        addCommands(
            ...
            factory.generateCommandFromFile("ClimbRight", false).alongWith(new WaitCommand(0.5).andThen(new ArmPowerCommand(Constants.STOWED_ARM_POSITION, arm, 3))),
