  ...
  public BumpSideThreeElementRight(
    ...
    addCommands(
        ...
        new ArmPowerCommand(Constants.AUTON_SAFECHUCK, arm, 3)
            .alongWith(factory.generateCommandFromFile("BumpSideRightBowlFirst", false, 4, 2.5)).alongWith(new WaitCommand(1.3).andThen(new InstantCommand(() -> endAffector.fastOutake()))),
