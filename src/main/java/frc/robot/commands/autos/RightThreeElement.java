  ...
  public RightThreeElement(
    ...
    addCommands(
        ...
        new ArmPowerCommand(Constants.HIGH_STOWED_ARM_POSITION, arm, 3)
            ...
            .alongWith(factory.generateCommandFromFile("ScoreSecondElementRight", false, 3, 3).alongWith(new WaitCommand(0.5).andThen(new InstantCommand(()-> endAffector.fastOutake())))));
  }
}
