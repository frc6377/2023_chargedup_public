...
public class Pods {
  ...
  private static void init() {
    ...
    Pods.addPod(
        PodName.G,
        new PodConstantsBuilder().setEncoderID(13).setEncoderOffset(-Math.toRadians(156.182)));
    ...
    Pods.addPod(
        PodName.E,
        new PodConstantsBuilder().setEncoderID(9).setEncoderOffset(-Math.toRadians(200.742)));
